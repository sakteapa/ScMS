  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl overflow-hidden my-6 flex flex-col max-h-[92vh]">
        {/* Header */}
        <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-800 bg-gray-950/80 flex items-center justify-between gap-2 shrink-0">
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                ...
                <span className={`text-[9px] sm:text-[10px] px-2 py-0.5 rounded-full font-mono border shrink-0 ${
                  scheduleStatus === 'open'
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-1.5 sm:p-2 text-gray-400 hover:text-white rounded-lg hover:bg-gray-800 transition-colors cursor-pointer shrink-0"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Tab Navigation */}
        <div className="flex border-b border-gray-800 bg-gray-900/60 px-3 sm:px-6 py-2 sm:py-2.5 gap-2 sm:gap-3 shrink-0 overflow-x-auto no-scrollbar">
          <button
            type="button"
          ...
          >
            ...
            <span className="hidden sm:inline">New Student Online Registration</span>
            <span className="sm:hidden">Online Registration</span>
          </button>
          <button
            type="button"
